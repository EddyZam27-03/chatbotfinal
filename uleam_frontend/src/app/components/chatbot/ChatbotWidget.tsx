...
export function ChatbotWidget() {
  ...
  if (!isOpen) {
    return (
      ...
      >
        <Bot size={28} style={{ color: 'var(--uleam-text-inverse)' }} />
      </button>
    );
  }
  ...
  return (
    <div
      className="fixed bottom-5 right-5 md:bottom-6 md:right-6 z-50 flex flex-col bg-white rounded-[var(--radius-widget)] shadow-[var(--uleam-shadow-2)] overflow-hidden"
      style={{
        width: '92vw',
        maxWidth: '360px',
        height: '70vh',
    ...
    >
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="font-semibold text-sm" style={{ color: 'var(--uleam-text)' }}>
              Asistente Académico
            </div>
      ...
      {/* Suggestions */}
      {messages.length <= 1 && (
        <div className="px-3 py-2 border-b" style={{ borderColor: 'var(--uleam-border)' }}>
      ...
      {showScrollButton && (
        ...
        >
          <ChevronDown size={18} style={{ color: 'var(--uleam-text-inverse)' }} />
        </button>
      )}
      ...
      <div
        ...
        style={{ borderColor: 'var(--uleam-border)', backgroundColor: 'var(--uleam-surface)' }}
      >
        <div className="flex items-end space-x-2">
          ...
          >
            <Send size={18} style={{ color: 'var(--uleam-text-inverse)' }} />
          </button>
        </div>
      </div>
    </div>
